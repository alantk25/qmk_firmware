...
#define LAYOUT_emu( \
  ...
  LD1,    LD2, LD3, LD4, LD5, LD6,      RD1, RD2, RD3, RD4,    RD6, RD7, RD8, RD9, \
  LE1,  LE2, LE3, LE4,   LE5, LE6,      RE1, RE2,    RE4, RE5, RE6, RE7, RE8, RE9 \
  ) \
  { \
    { LA1, LA2, LA3, LA4, LA5, LA6, LA7, KC_NO }, \
    { LB1, LB2, LB3, LB4, LB5, LB6, KC_NO, KC_NO }, \
    { LC1, LC2, LC3, LC4, LC5, LC6, KC_NO, KC_NO }, \
    { LD1, LD2, LD3, LD4, LD5, LD6, KC_NO, KC_NO }, \
    { LE1, LE2, LE3, LE4, LE5, LE6, KC_NO, KC_NO }, \
    { KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO }, \
